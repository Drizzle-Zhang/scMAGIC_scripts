...
path.output <- '/mdshare/node9/zy/scMAGIC/atlas_anno/'
dataset <- 'Tasic2018'
...
OUT <- readRDS(paste0('/mdshare/node9/zy/scMAGIC/Benchmark/mouse_brain/', dataset, '.Rdata'))
...
library(ggplot2)
path.res <- '/mdshare/node9/zy/scMAGIC/figure/atlas_anno/'
method <- 'scMAGIC'
