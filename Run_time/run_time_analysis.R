...
mat.ref <- exp_Hochgerner
tags.ref <- label_Hochgerner[,1]
...
file.runtime <- '/mdshare/node9/zy/scMAGIC/run_time/ref_5000_query_2000_20000.txt'
...
ggsave(filename = 'RunTime.png',
       path = '/mdshare/node9/zy/scMAGIC/run_time', plot = plot.time,
