...
setwd('/local/zy/my_git/scMAGIC/Benchmark/cross_validation/train4_test1/panc8_indrop')
...
path.output <- '/mdshare/node9/zy/scMAGIC/cross_validation/train4_test1/panc8_indrop/'
