...
setwd('/local/zy/my_git/scMAGIC/Benchmark/cross_validation/train4_test1/pbmcsca_10Xv2')
source('./Cross_Validation.R')
source('./method_functions.R')
source('./evaluate.R')

path.input <- '/mdshare/node9/zy/scMAGIC/sc_data/'
path.output <- '/mdshare/node9/zy/scMAGIC/cross_validation/train4_test1/pbmcsca_10Xv2/'
