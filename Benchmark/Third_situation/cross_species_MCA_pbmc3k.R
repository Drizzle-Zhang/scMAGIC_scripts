...
path.output <- '/mdshare/node9/zy/scMAGIC/Benchmark/cross_species/'

############# regard sc-counts data as reference
ref.dataset <- 'MCA'
file.save <- paste0(path.output, ref.dataset, '1.Rdata')
# file.mtx <- '/home/disk/scMAGIC/MouseAtlas_SingleCell_Han2018/MCA_by_tissue/PeripheralBlood/Count_all_batch.txt'
# df.mtx <- read.delim(file.mtx, stringsAsFactors = F, row.names = 1)
# file.cellid <- '/home/disk/scMAGIC/MouseAtlas_SingleCell_Han2018/MCA_by_tissue/PeripheralBlood/CellAssignments_all_batch.txt'
...
output.scMAGIC <- scMAGIC(exp_sc_mat, ref.mtx, ref.labels, num_threads = 8)
